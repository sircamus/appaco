	...
	<div class="row">
		...
		<div class="col-md-9" id="mainCol">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h4 class="no-margin padding-tb"><i class="glyphicon glyphicon-calendar"></i> &nbsp; Más recientes </h4>
					</div>
						...
						<div class="row">
							<div class="col-sm-4 col-md-4">
								<div class="thumbnail">
									...
									<div class="caption">
										<h4><a href="#">Titulo del Post</a> <br> <small><a href="" class="txt-gray">Nombre Completo</a></small></h4>
										<div class="row">
											<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h4 class="no-margin padding-tb"> <i class="glyphicon glyphicon-comment"></i> &nbsp; Más comentadas</h4>
					</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h4 class="no-margin padding-tb"><i class="glyphicon glyphicon-check"></i> &nbsp;Finalizadas</h4>
					</div>
